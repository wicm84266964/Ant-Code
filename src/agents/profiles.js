...
export const AGENT_PROFILES = Object.freeze([
  {
    ...
    aliases: ["default"],
    hidden: true,
    tools: ["read_file", "list_files", "glob", "grep", "git_status", "git_diff", "web_fetch", "web_search", "document_intake", "write_file", "edit_file", "powershell", "bash", "background_shell", "mcp_list", "mcp_call", "skill_list", "skill_read", "skill_run", "agent_run", "todo_read", "todo_write", "plan_update", "ask_user"],
  ...
  },
  {
    name: "verifier",
    mode: "execute",
    tools: ["read_file", "list_files", "glob", "grep", "git_status", "git_diff", "web_fetch", "document_intake", "powershell", "bash", "background_shell", "mcp_list", "mcp_call", "skill_list", "skill_read"],
  ...
  },
  {
    ...
    tools: ["read_file", "list_files", "glob", "grep", "git_status", "git_diff", "web_fetch", "document_intake", "write_file", "edit_file", "powershell", "bash", "background_shell", "mcp_list", "mcp_call", "skill_list", "skill_read", "skill_run", "todo_read", "todo_write", "plan_update"],
  ...
  },
  {
    ...
    tools: ["read_file", "list_files", "glob", "grep", "web_fetch", "powershell", "bash", "background_shell", "mcp_list", "mcp_call", "skill_list", "skill_read", "skill_run"],
    role: "verifier",
    purpose: "browser",
    modelTier: "default",
    canSpawnAgents: false,
  ...
  },
  {
    ...
    tools: ["read_file", "list_files", "glob", "grep", "git_status", "git_diff", "web_fetch", "document_intake", "powershell", "bash", "background_shell", "mcp_list", "mcp_call", "skill_list", "skill_read", "skill_run"],
    role: "verifier",
    purpose: "visual",
    modelTier: "vision",
    canSpawnAgents: false,
