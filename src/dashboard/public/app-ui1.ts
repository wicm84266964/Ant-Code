...
export function emptyStateCopy(width: number = Number(window.innerWidth) || 1200) {
  return width >= 1200
    ? "过程折叠。结果展开。文件留在右侧。"
    : "过程折叠。结果展开。文件在「文件」页。";
}

export function syncEmptyStateCopy(width: number = Number(window.innerWidth) || 1200) {
