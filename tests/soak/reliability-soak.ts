...
} from "../../src/agents/background-terminal-registry.ts";
import { createDashboardRuntime } from "../../src/dashboard/sessions.ts";
import { parseOpenAIChatCompletionStream } from "../../src/model-gateway/openai-chat.ts";
 ...
 */
export async function runReliabilitySoak(input: Record<string, unknown> = {}) {
