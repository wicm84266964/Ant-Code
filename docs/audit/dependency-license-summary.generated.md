...
Root package: @ant-code/cli@3.0.0
...
| --- | --- | --- | --- |
| esbuild | development | 0.28.0 | MIT |
| postject | development | 1.0.0-alpha.6 | MIT |
| ink | runtime | 6.8.0 | MIT |
| katex | runtime | 0.16.46 | MIT |
| mermaid | runtime | 11.15.0 | MIT |
| react | runtime | 19.2.5 | MIT |
| yaml | runtime | 2.9.0 | ISC |
