...
Include the affected version or commit, a minimal reproduction, the expected impact, and any suggested mitigation. Remove API keys, gateway credentials, private source code, prompts, transcripts, local paths, and personal data before attaching logs or screenshots.
